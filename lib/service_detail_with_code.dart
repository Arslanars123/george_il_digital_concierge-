...
import 'package:untitled6/test/six_screen.dart';
...
class ServiceDetailsCode extends StatefulWidget {
  ServiceDetailsCode(
      {Key? key,
      required this.data,
  ...
  @override
  State<ServiceDetailsCode> createState() => _ProductDetailState();
}

class _ProductDetailState extends State<ServiceDetailsCode> {
  ...
  Future internet() async {
    ...
    if (connection == true) {
      ...
      var url = 'http://giovannis37.sg-host.com/api/get-service-detail';
      Map data = {
              ...
              child: Scaffold(
                body: Column(
                  ...
                  children: [
                    ...
                    widget.data['images'].length != null
                        ? Align(
